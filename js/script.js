...
const labels = ["Baloncesto","Béisbol","Fútbol"];
...
const barWidth = 50; //ANCHO DE BARRAS
...
function drawBars(){
    for(let i=0;i<labels.length; i++){
        ...
        const barHeight = (values[i]/maxValue) * charHeight; //ESTA ES LA ALTURA PROPORCIONAL DE CADA BARRA, CONSIDERANDO EL BUCLE FOR
